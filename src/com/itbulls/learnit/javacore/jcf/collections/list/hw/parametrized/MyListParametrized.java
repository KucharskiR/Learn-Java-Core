...
public interface MyListParametrized<T> extends Iterable<T> {
	 ...
	 */
	 ...
	 boolean containsAll(MyListParametrized<?> c); // returns true if this list contains all of the elements of the specified list
	}
